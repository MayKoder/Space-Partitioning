...
void AABBNode::Init(AABBTree* s_root, AABBNode* s_parent, int s_x, int s_y, int s_w, int s_h)
{
	root = s_root;
	parent = s_parent;
	minPos.x = s_x; minPos.y = s_y;
	maxPos.x = s_x + s_w; maxPos.y = s_y + s_h;
...
void AABBNode::SetRect(int& s_x, int& s_y, int& s_w, int& s_h)
{
...
//////////////// QUAD TREE ////////////////
AABBTree::AABBTree() : type(TreeType::ORTHOGRAPHIC), lowest_height(0), tile_width(0), tile_height(0)
{
}
